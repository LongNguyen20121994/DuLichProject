...
<head>
<meta charset="utf-8">
<title>Cập nhật khu vực ưu tiên</title>
	...
	<div class="container content">
		<div class="row">
			﻿﻿<div class="col-md-8 left">
				<div class="col-md-12">
				    <h2 style="margin-bottom:0px;">Cập nhật khu vực ưu tiên</h2>
					...
					<ul class="nav nav-tabs">
						...
						<li class="${classList}"><a data-toggle="tab" href="#excel">Danh sách khu vực ưu tiên</a></li>
					</ul>
					<div class="tab-content">
						<div id="input" class="tab-pane fade in ${classInput}">
							<h3>Nhập thông tin</h3>
							<s:form action="capNhatKhuVucUT.trip" method="post">
								<table class="table">
                                    <tr>
                                        <td style="padding-top: 15px; width:100px;">Mã khu vực</td>
                                        <td>
                                        	<div class="input-group">
                                        		<span class="input-group-addon" id="basic-addon1"><span class="glyphicon glyphicon-refresh"></span></span>
                                        		<s:textfield name="kv.maKV" cssClass="form-control" readonly="%{(maKV != null?'true':'false')}" aria-describedby="basic-addon1" placeholder="Mã khu vực"></s:textfield>
                                        	</div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                        	<div class="input-group">
                                        		...
                                        		<s:textfield name="kv.tenKhuVuc" cssClass="form-control" aria-describedby="basic-addon1" placeholder="Tên khu vực"></s:textfield>
                                        	</div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                        	<div class="input-group">
                                        		<span class="input-group-addon" id="basic-addon1"><span class="glyphicon glyphicon-file"></span></span>
                                        		<input type="number" name="kv.diemCong" step="0.01" value="${kv.diemCong}" class="form-control" aria-describedby="basic-addon1" placeholder="Điểm cộng"/>
                                        	</div>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                    	<td colspan="2">
                                        	<s:textarea name="kv.ghiChu" id="ghiChu"></s:textarea>
						...
						<div id="excel" class="tab-pane fade in ${classList}" style="width:100%;">
							<h3>Danh sách khu vực ưu tiên</h3>
							<s:form action="capNhatListKhuVucUT.trip" method="post" enctype="multipart/form-data">
								<table id="table" class="table table-striped table-bordered"  style="width:100%;">
							        <thead>
							            <tr>
							                <th style="text-align: center; width:100px;">Mã khu vực</th>
							        ...
							        <tbody>
							 			<s:iterator value="list" >
							       			<tr>
								                <td align="center"><s:property value="maKV"/></td>
								                <td><s:property value="tenKhuVuc"/></td>
								                <td align="center"><s:property value="diemCong"/></td>
								                <td align="center"><s:checkbox name="listMaKV" fieldValue="%{maKV}" value="false"/></td>
							           		 </tr>
							       		</s:iterator>
							       	</tbody>
							    </table>
							...
							<script>
								function setCheck() {
									var cboxes = document.getElementsByName('listMaKV');
