...
<head>
<meta charset="utf-8">
<title>Thêm trường Trung học phổ thông</title>
				...
				<div class="col-md-12">
					...
					<div class="tab-content">
						<div id="input" class="tab-pane fade in active">
							...
							<s:form action="themTruongTHPT.trip" method="post">
								<table class="table">
                                    <tr>
                                        ...
                                        <td>
                                        	<div class="input-group">
                                        		...
                                        		<s:textfield name="truong.maTruong" cssClass="form-control" aria-describedby="basic-addon1" placeholder="Mã trường"></s:textfield>
                                        	</div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                        	<div class="input-group">
                                        		...
                                        		<s:textfield name="truong.tenTruong" cssClass="form-control" aria-describedby="basic-addon1" placeholder="Tên trường"></s:textfield>
                                        	</div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding-top: 15px;">Khu vực</td>
                                        <td>
                                        	<div class="input-group">
                                        		<span class="input-group-addon" id="basic-addon1"><span class="glyphicon glyphicon-transfer"></span></span>
                                         		<s:select name="truong.khuVucUT" list="listKV" listKey="maKV" listValue="tenKhuVuc" cssClass="form-control" aria-describedby="basic-addon1" headerKey="-1" headerValue="Chọn khu vực ưu tiên"></s:select>
                                        	</div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                        	<div class="input-group">
                                        		<span class="input-group-addon" id="basic-addon1"><span class="glyphicon glyphicon-transfer"></span></span>
                                         		<s:select name="truong.maTinh" list="listTinh" cssClass="form-control" aria-describedby="basic-addon1" headerKey="-1" headerValue="Chọn tỉnh (thành phố)"></s:select>
                                        	</div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                        	<div class="input-group">
                                        		<span class="input-group-addon" id="basic-addon1"><span class="glyphicon glyphicon-file"></span></span>
                                         		<s:textfield name="truong.diaChi" cssClass="form-control" aria-describedby="basic-addon1" placeholder="Địa chỉ"></s:textfield>
                                        	</div>
                                        </td>
                                    </tr>
                                    <tr>
						...
						<div id="excel" class="tab-pane fade" style="width:100%;">
							...
							<s:form action="addTruongTHPTExcel.trip" method="post" enctype="multipart/form-data">
								<div class="input-group">
									<table class="table">
                                        <tr>
