...
<script type="text/javascript">
	$(document).ready(function() {
	    ...
	    $("#selectDS" ).change(function() {
	    	$.post("ajaxTaiKhoanKhoa.trip",
   		    {
   				account: $("#selectDS").val(),
   		    },
   		    function(data,status){
   		  		    $("#danhSachTaiKhoan").html(data);
   		    });
       	});
	});
</script>
		...
		<div class="row">
			<div class="col-md-8">
				...
				<div class="tab-content">
					...
					<h2 style="margin-bottom:0px;">Danh sách tài khoản bị khóa</h2>
			            <s:a href=""><small><small><i>Bạn phải chịu tất cả trách nhiệm về tác vụ đang xử lý.</i></small></small></s:a>
			            <br><br>
			            <s:form method="post" action="quanLyTaiKhoanKhoa.trip">
					        ...
					        <div id="danhSachTaiKhoan">
							    ...
							    <div  align="right">
					                <s:submit value="Mở khóa" name="btnSua" cssClass="btn btn-primary"/>
