	...
	<div class="container content">
		<div class="row">
			﻿﻿<div class="col-md-8 left">
				<div class="col-md-12">
				    <h2 style="margin-bottom:0px;">Cập nhật môn thi</h2>
					...
					<ul class="nav nav-tabs">
						...
						<li class="${classList}"><a data-toggle="tab" href="#excel">Danh sách môn thi</a></li>
					</ul>
					<div class="tab-content">
						<div id="input" class="tab-pane fade in ${classInput}">
							<h3>Nhập thông tin</h3>
							<s:form action="themMonThi.trip" method="post">
								<table class="table">
                                    <tr>
                                        <td style="padding-top: 15px; width:100px;">Mã môn thi</td>
                                        <td>
                                        	<div class="input-group">
                                        		<span class="input-group-addon" id="basic-addon1"><span class="glyphicon glyphicon-refresh"></span></span>
                                        		<s:textfield name="mt.maMonThi" cssClass="form-control" readonly="%{(maMT != null?'true':'false')}" aria-describedby="basic-addon1" placeholder="Mã môn thi"></s:textfield>
                                        	</div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding-top: 15px;">Tên môn thi</td>
                                        <td>
                                        	<div class="input-group">
                                        		<span class="input-group-addon" id="basic-addon1"><span class="glyphicon glyphicon-file"></span></span>
                                        		<s:textfield name="mt.tenMonThi" cssClass="form-control" aria-describedby="basic-addon1" placeholder="Tên môn thi"></s:textfield>
                                        	</div>
                                        </td>
                                    </tr>
                                    <tr>
						...
						<div id="excel" class="tab-pane fade in ${classList}" style="width:100%;">
							...
							<s:form action="capNhatListMonThi.trip" method="post" enctype="multipart/form-data">
								<table id="table" class="table table-striped table-bordered"  style="width:100%;">
							        <thead>
							            <tr>
							                <th style="text-align: center; width:100px;">Mã môn thi</th>
							                <th style="text-align: center;">Tên môn thi</th>
							                <th style="text-align: center;width:65px;">Cập nhật</th>
							            </tr>
							        </thead>
							       	<tfoot>
							       		 <tr>
							                <th style="text-align: center;">Mã môn thi</th>
							                <th style="text-align: center;">Tên môn thi</th>
							        ...
							        <tbody>
							 			<s:iterator value="list" >
							       			<tr>
								                <td align="center"><s:property value="maMonThi"/></td>
								                <td><s:property value="tenMonThi"/></td>
								                <td align="center"><s:checkbox name="listMaMT" fieldValue="%{maMonThi}" value="false"/></td>
							           		 </tr>
							       		</s:iterator>
							       	</tbody>
							    </table>
							...
							<script>
								function setCheck() {
									var cboxes = document.getElementsByName('listMaMT');
