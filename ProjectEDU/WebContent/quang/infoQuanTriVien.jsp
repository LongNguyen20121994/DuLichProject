		...
		<div class="row">
			<div class="col-md-8">
		        ...
		        <div class="col-md-4" style="margin:0px 0px 10px 0px; ">
		        	<img src="${qtv.hinhAnh}" class="img-thumbnail" width="100%" />
		        </div>
		        <div class="col-md-8">
		        	<table class="table">
		        		<tr>
		        			<td style="width:180px; padding-top:8px;"><strong>Số CMND</strong></td>
		        			<td><b>: </b><s:property value="qtv.soCMND"></s:property></td>
		        		</tr>
		        		<tr>
		        			<td style="padding-top:8px;"><strong>Họ tên</strong></td>
		        			<td><b>: </b><s:property value="qtv.hoTen"></s:property></td>
		        		</tr>
		        		<tr>
		        			<td style="padding-top:8px;"><strong>Ngày sinh</strong></td>
		        			<td><b>: </b><s:property value="qtv.ngaySinh"></s:property></td>
		        		</tr>
		        		
		        		<tr>
		        			<td style="padding-top:8px;"><strong>Giới tính</strong></td>
		        			<td><b>: </b>${qtv.gioiTinh == true ?"Nam":"Nữ" }</td>
		        		</tr>
		        		<tr>
		        			<td style="padding-top:8px;"><strong>Số ĐT</strong></td>
		        			<td><b>: </b><s:property value="qtv.soDT"></s:property></td>
		        		</tr>
		        		<tr>
		        			<td style="padding-top:8px;"><strong>Email</strong></td>
		        			<td><b>: </b><s:property value="qtv.email"></s:property></td>
		        		</tr>
		        		<tr>
