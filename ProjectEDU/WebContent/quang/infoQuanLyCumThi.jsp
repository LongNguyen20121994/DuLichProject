		        ...
		        <div class="col-md-8">
		        	<table class="table">
		        		<tr>
		        			...
		        			<td><b>: </b><s:property value="qlct.soCMND"></s:property></td>
		        		</tr>
		        		<tr>
		        			<td style="padding-top:8px;"><strong>Họ tên</strong></td>
		        			<td><b>: </b><s:property value="qlct.hoTen"></s:property></td>
		        		</tr>
		        		<tr>
		        			<td style="padding-top:8px;"><strong>Ngày sinh</strong></td>
		        			<td><b>: </b><s:property value="qlct.ngaySinh"></s:property></td>
		        		</tr>
		        		
		        		<tr>
		        			<td style="padding-top:8px;"><strong>Giới tính</strong></td>
		        			<td><b>: </b>${qlct.gioiTinh == true ?"Nam":"Nữ" }</td>
		        		</tr>
		        		<tr>
		        			<td style="padding-top:8px;"><strong>Số ĐT</strong></td>
		        			<td><b>: </b><s:property value="qlct.soDT"></s:property></td>
		        		</tr>
		        		<tr>
		        			<td style="padding-top:8px;"><strong>Email</strong></td>
		        			<td><b>: </b><s:property value="qlct.email"></s:property></td>
		        		</tr>
		        		<tr>
		        		...
		        		<tr>
		        			<td style="padding-top:15px;"><strong>Cụm thi</strong></td>
		        			<td><b>: </b><s:property value="qlct.donViThi"></s:property> - <s:property value="tenCumThi"></s:property></td>
	        			</tr>
		        		<tr>
