	...
	<div class="container content">
		<div class="row">
			﻿﻿<div class="col-md-8 left">
				<div class="col-md-12">
				    <h2 style="margin-bottom:0px;">Cập nhật phòng thi</h2>
					...
					<ul class="nav nav-tabs">
						...
						<li class="${classList }"><a data-toggle="tab" href="#excel">Danh sách phòng thi</a></li>
					</ul>
					<div class="tab-content">
						<div id="input" class="tab-pane fade in ${classInput }">
							<h3>Nhập thông tin</h3>
							<s:form action="capNhatPhongThi.trip" method="post">
								<table class="table">
                                    <tr>
                                        ...
                                        <td>
                                        	<div class="input-group">
                                        		...
                                        		<s:textfield name="pt.maPT" cssClass="form-control" readonly="%{(maPT!=null?'true':'false')}" aria-describedby="basic-addon1" placeholder="Mã phòng thi"></s:textfield>
                                        	</div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding-top: 15px;">Tên phòng thi</td>
                                        <td>
                                        	<div class="input-group">
                                        		<span class="input-group-addon" id="basic-addon1"><span class="glyphicon glyphicon-paperclip"></span></span>
                                        		<s:textfield name="pt.tenPT" cssClass="form-control" aria-describedby="basic-addon1" placeholder="Tên phòng thi"></s:textfield>
                                        	</div>
                                        </td>
                                    </tr>
                                    <tr>
										<td style="padding-top: 15px;">Địa điểm thi</td>
										<td>
											<div class="input-group">
												<span class="input-group-addon" id="basic-addon1"><span
													class="glyphicon glyphicon-transfer"></span></span>
												<s:select name="pt.maDDT" id="maDDT" cssClass="form-control"
													list="listDiaDiemThi" aria-describedby="basic-addon1"
													headerKey="-1" headerValue="Chọn địa điểm thi" />
											</div>
										</td>
									</tr>
                                    <tr>
						...
						<div id="excel" class="tab-pane fade in ${classList }" style="width:100%;">
							...
							<s:form action="capNhatListPhongThi.trip" method="post" enctype="multipart/form-data">
