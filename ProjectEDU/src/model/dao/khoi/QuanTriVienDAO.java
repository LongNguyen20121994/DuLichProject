...
public class QuanTriVienDAO {
        ...
        try {
        	...
        	for(String tmp : listSoCMND){
	    		...
	    		if(check > 0){
	    			...
	    			if(rsEmail.next()){
	    				String tieuDe = (trangThai && !logined?"KiÌ�ch hoaÌ£t" : trangThai && logined?"Má»Ÿ khÃ³a" : "KhÃ³a") + " taÌ€i khoaÌ‰n quaÌ‰n triÌ£ viÃªn";
	    				...
	    				if(trangThai && !logined) {
		    				noiDung.append("<div style='padding:2% 3.5%;'><p>BaÌ£n Ä‘aÌƒ thÆ°Ì£c hiÃªÌ£n Ä‘Äƒng kyÌ� taÌ€i khoaÌ‰n quaÌ‰n triÌ£ viÃªn");
		    				...
		    				noiDung.append("<ul><li>CÃ¢Ì£p nhÃ¢Ì£t TiÌ‰nh, HuyÃªÌ£n, XaÌƒ</li><li>CÃ¢Ì£p nhÃ¢Ì£t danh saÌ�ch caÌ�c trÆ°Æ¡Ì€ng Ä�aÌ£i hoÌ£c - Cao Ä‘ÄƒÌ‰ng</li>");
		    				noiDung.append("<li>CÃ¢Ì£p nhÃ¢Ì£t cuÌ£m thi</li><li>CÃ¢Ì£p nhÃ¢Ì£t Danh saÌ�ch caÌ�c ngaÌ€nh Ä‘aÌ€o taÌ£o</li><li>CÃ¢Ì£p nhÃ¢Ì£t danh saÌ�ch caÌ�c trÆ°Æ¡Ì€ng Trung hoÌ£c phÃ´Ì‰ thÃ´ng</li>");
		    				noiDung.append("<li>PhÃª duyÃªÌ£t, kiÌ�ch hoaÌ£t caÌ�c taÌ€i khoaÌ‰n</li><li>Ä�iÃªÌ€u haÌ€nh kyÌ€ thi (CÃ¢Ì£p nhÃ¢Ì£t nÄƒm tuyÃªÌ‰n sinh, mÃ´n thi...)</li>");
		    				noiDung.append("<li>CÃ¢Ì£p nhÃ¢Ì£t Ä‘Æ¡Ì£t xeÌ�t tuyÃªÌ‰n, khÃ´Ì�i thi...</li></ul>");
	...
	public boolean quenMatKhau(String soCMND, String email) {
        ...
        try {
    		...
    		ResultSet rsEmail = stmtEmail.executeQuery();
    		if(rsEmail.next()){
				String tieuDe = "QuÃªn máº­t kháº©u tÃ i khoáº£n quáº£n trá»‹ viÃªn";
				StringBuilder noiDung = new StringBuilder("<div style='border:5px inset #CCC;'>");
				noiDung.append("<h2 style='background-color:#4d90fe;padding:1.5% 3%; margin:2px;'>Xin chÃ o " + rsEmail.getString(1) + "</h2>");
